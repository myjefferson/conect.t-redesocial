<link rel="stylesheet" href="style_cli/css_cli/alterar_conta.css"> 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="perfil_cli.php" enctype="multipart/form-data">
                    <!--nome e da foto do cliente-->                                
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="perfil_cli.php">
                        <p>Digite sua descrição:</p> <textarea type="text" class="form-control" name="descricao" id="descricao" placeholder="Quem sou eu..."></textarea><br>
...
function altera_foto_perfil(){
    ...
    if(!empty($foto_perfil)){
        ...
        move_uploaded_file($_FILES['foto_perfil']['tmp_name'], "fotos_cli/".$nome_foto);
        // Pega a extensão
        ...
        if(strstr('.jpg;.jpeg;.png;.bmp', $extensao)){
            ...
            echo"<script>
                ...
                window.location = 'perfil_cli.php';
            </script>";
        }      
    }else{
        header("Location: perfil_cli.php");
...
function altera_capa_perfil(){
    ...
    if(!empty($foto_capa)){
        ...
        move_uploaded_file($_FILES["foto_capa"]['tmp_name'], "fotos_cli/".$nome_capa);
        // Pega a extensão
...
function altera_perfil(){
    ...
    $refresh = header("Location: perfil_cli.php");

    if(!empty($senha)){
        $query_senha = mysqli_query($conexao, 'SELECT senha FROM cliente');
        $senha_cli = mysqli_fetch_assoc($query_senha);

        if ($senha_cli['senha'] != md5($senha)){
