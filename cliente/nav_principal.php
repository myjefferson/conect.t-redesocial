<?php
    ...
    if($id_cli == ""){header("Location: login_cli.php");} 
...
<html lang="pt_br">
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" href="style_cli/css_cli/nav_principal.css">
                ...
                <div id="usuario" class="position-fixed">
                    ...
                    <nav class="options">
                        ...
                        <ul class="nav flex-column nav-tabs" id="nav-tab">
                            <li class="nav-item"><a href="home_cli.php" ><div class="logo"><i><img class="float-md-left" src="style_cli/img_cli/logo-black.png" alt="CONECT.T"></i></div></a></li>
            ...
            <nav class="options-mobile">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="buttons-mobile nav-tabs">
                        <li><a href='perfil_cli.php' class='nav-link perfil' name='perfil-mobile' id="perfil"><?php echo "<img src='fotos_cli/".$foto_cli['foto']."' onerror=this.src='style_cli/img_cli/sem-perfil.png'>"; ?></a> <p>Meu perfil</p></li>                      
