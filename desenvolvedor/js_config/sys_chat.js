$(document).ready(function(){  
    $('#btn_enviar_msm').click(function(e){
        ...
        var id_dev_enviou = $('#id_dev_enviou').val();

        var type_user_recebeu = $('#type_user_recebeu').val();
        var id_user_recebeu = $('#id_user_recebeu').val();
        
        var dataString = 'mensagem=' + mensagem + '&type_dev_enviou=' + type_dev_enviou + '&id_dev_enviou=' + id_dev_enviou + '&type_user_recebeu=' + type_user_recebeu + '&id_user_recebeu=' + id_user_recebeu
        //post para o php
        $.ajax({
            type: 'POST',
...
function list(){
    //var type_dev_enviou = $('#type_dev_enviou').val();
    var id_dev_enviou = $('input[name="id_dev_enviou"]').val();

    var type_user_recebeu = $('input[name="type_user_recebeu"]').val();
    var id_user_recebeu = $('input[name="id_user_recebeu"]').val();

    var dataString = 'user=' +id_user_recebeu+ '&type_user=' +type_user_recebeu+ '&id_dev_enviou='+id_dev_enviou;
