...
<head>
    ...
    <link rel="stylesheet" href="style_dev/css_dev/mensagens.css">
                    ...
                    <div id="pos-container" class="col-sm-12 col-md-8 col-lg-8 col-xl-8">  
                            ...
                            <div class="box-all-msm">
                                ...
                                <div id="msm-welcome">
                                    ...
                                    <p id="txt_info">Troque mensagens com amigos, clientes e investidores.</p>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12" id="form">
                                        ...
                                        <input type="hidden" name="type_dev_enviou" id="type_dev_enviou" value="<?php echo$_SESSION['type_user']; ?>">
                                        <input type="hidden" name="id_dev_enviou" id="id_dev_enviou" value="<?php echo$_SESSION['id_dev']; ?>">
